...
import SignupPopup from '../Screen/tabScreen/SignupPopup';

const { height, width } = Dimensions.get('window');

const WithoutSignupHome = ({ navigation }) => {
            ...
            <ScrollView style={{
                ...
                <View style={{
                    ...
                    <Text style={{
                        ...
                        textAlign: 'center',
                        color: '#1E202B',
                    }}>Continue to the sign up page to start exploring more content.</Text>
