...
import { View, Text, StyleSheet, TextInput, Image, TouchableOpacity, Keyboard, Alert, ScrollView, SafeAreaView } from 'react-native';
                ...
                <View style={{ flex: .8 }}>
                    ...
                    <View style={{
                        ...
                        <Text style={{
                            ...
                            color: '#000F1A',
                            top: 20
                        }}>It's important to choose a strong and unique password for your account to keep it secure</Text>
                    </View>
                    ...
                    <View style={{ marginTop: moderateScale(10) }}>
                        ...
                        <View style={styles.section}>
                            <CheckBox
                                ...
                                onValueChange={(newValue) => setToggleCheckBox(newValue)}
                            />
                            <Text style={styles.paragraph}>At least one special character (E.g @%$</Text>
