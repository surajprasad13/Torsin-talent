...
import { View, Text, StyleSheet, SafeAreaView, Image, TouchableOpacity, ScrollView, Keyboard, Alert } from 'react-native';
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: '#ffffff' }}>
      ...
      <TouchableOpacity
        ...
        style={{
          ...
          marginLeft: '7.5%',
          backgroundColor: inputs.password && inputs.confirm_password ? '#0E184D' : '#E0E0E0',
          justifyContent: 'center',
          borderRadius: 8
        }}>
        <Text style={{
